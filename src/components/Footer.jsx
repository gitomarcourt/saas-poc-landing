      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 text-gray-300">
              Votre proof of concept fonctionnel en 7 jours.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#process" className="text-gray-300 hover:text-white transition-colors duration-300">
                  Notre processus
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="mailto:contact@saaspoc.com" className="text-gray-300 hover:text-white transition-colors duration-300">
                  contact@saaspoc.com
                </a>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <p className="text-center text-gray-300">
            {currentYear} POC7. Tous droits réservés.
          </p>
        </div>
      </div>
    </footer>
